...
class LineAnalyzer
  ...
  def calculate_word_frequency()
    ...
    split_content.each { |word| frequency[word.downcase] += 1 }
...
class Solution
  ...
  def print_highest_word_frequency_across_lines()
    ...
    highest_count_words_across_lines.each do |line_analyzer|
      puts "#{line_analyzer.highest_wf_words.to_s} (appears in line #{line_analyzer.line_number})"
    end
